...
CompanyBuilding::CompanyBuilding(std::string name, const std::string& modelPath, const std::string& texturePath,
...
void CompanyBuilding::draw(bool isPicking)
{
	this->shader_->bind();
...
void CompanyBuilding::rotate(float angle, const glm::vec3& axis)
{
