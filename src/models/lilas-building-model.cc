...
LilasBuilding::LilasBuilding(std::string name, const std::string& modelPath, const std::string& texturePath,
...
void LilasBuilding::draw(bool isPicking)
{
	this->shader_->bind();
...
void LilasBuilding::rotate(float angle, const glm::vec3& axis)
{
