...
BigBuilding::BigBuilding(std::string name, const std::string& modelPath, const std::string& texturePath,
...
void BigBuilding::draw(bool isPicking)
{
	this->shader_->bind();
...
void BigBuilding::rotate(float angle, const glm::vec3& axis)
{
