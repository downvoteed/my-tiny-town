...
OfficeBuilding::OfficeBuilding(std::string name, const std::string& modelPath, const std::string& texturePath,
...
void OfficeBuilding::draw(bool isPicking)
{
	this->shader_->bind();
...
void OfficeBuilding::rotate(float angle, const glm::vec3& axis)
{
