...
Skyscraper::Skyscraper(std::string name, const std::string& modelPath, const std::string& texturePath,
...
void Skyscraper::draw(bool isPicking)
{
	this->shader_->bind();
...
void Skyscraper::rotate(float angle, const glm::vec3& axis)
{
